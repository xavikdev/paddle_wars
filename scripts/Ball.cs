...
public partial class Ball : Area2D
{
	...
	private AudioStreamPlayer boundSound;

	private static readonly Vector2 StartingPoint = new() { X = 960, Y = 540};

    public override void _Ready()
    {
        boundSound = GetNode<AudioStreamPlayer>("AudioStreamPlayer");
    }
